...
>>>>>>> 4204c46257bf0b2eb2feb9be106907b8c21d53f9
                            </div>
                        </ul>
                    </div>
                </div>
    ...
    <div class="section">
        <div class="row">
            <div class="col s16 m8 l12 main-content">
                ...
                <ul>
                    <li>ASIGNING REFERENCES-PHP references allow you to make two variables refer to the same content.
                    ...
                    <li>PASSING REFERENCES - The second thing references do is to pass variables by reference
                        <div class="code-sample">
                            <div class="code-comment">
                                //... Sample code
                            </div>
                    ...
                    <li>RETURN BY REFERENCE - The third thing references can do is return by reference.
                        <div class="code-sample">
                            <div class="code-comment">
                                //... Sample code
                            </div>
                    ...
                    <li>UNSETTING REFERENCES - When you unset the reference, you just break the binding between variable name and variable content.
                        <div class="code-sample">
                            <div class="code-comment">
                                //... Sample code
                            </div>
                    ...
                    <li>SPOTTING REFERENCES - Many syntax constructs in PHP are implemented via referencing mechanisms
                        <div class="code-sample">
                            <div class="code-comment">
                                //... Sample code
                            </div>
        ...
        <div class="row">
            <div class="col s16 m8 l12 main-content">
                ...
                <ul>
                    ...
                    <li>YIELDING VALUES WITH KEYS-PHP also supports associative arrays, and generators are no different. In addition to yielding simple values, you can also yield a key at the same time. Yielding a key/value pair
                    </li>
                    <li>YIELDING NULL VALUES-Yield can be called without an argument to yield a NULL value with an automatic key. Yielding NULLs
                        <div class="code-sample">
                            <div class="code-comment">
                                //... Sample code
                            </div>
                    ...
                    <li>YIELDING BY REFERENCE-Generator functions are able to yield values by reference as well as by value. Yielding values by reference
                    </li>
                </ul>
